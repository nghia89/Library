...
namespace BiTech.Library.Controllers
{
    public class MuonSachController : BaseController
    {
        public ActionResult Index(string IdUser)
        {
            ...
            list_user.Add(new UserViewModel() { MaSoThanhVien = "789", Ten = "Viet" });
            //Danh sách sách đang mượn
            List<MuonTraSachViewModel> list_book = new List<MuonTraSachViewModel>();
            list_book.Add(new MuonTraSachViewModel() { MaKiemSoat = "", IdUser = "123", TenSach = "One Piece tâp 1", SoLuong = "1", NgayMuon = (new DateTime(2018, 2, 20)).Date.ToString("dd-MM-yyyy"), NgayTra = (new DateTime(2018, 6, 28)).Date.ToString("dd-MM-yyyy"),
            ...
            list_book.Add(new MuonTraSachViewModel() { MaKiemSoat = "", IdUser = "456", TenSach = "One Piece tâp 4", SoLuong = "3", NgayMuon = (new DateTime(2018, 2, 20)).Date.ToString("dd-MM-yyyy"), NgayTra = (new DateTime(2018, 4, 28)).Date.ToString("dd-MM-yyyy"),
                TinhTrang = ((new DateTime(2018, 3, 28)) - DateTime.Now).TotalDays < 0
            });
            list_book.Add(new MuonTraSachViewModel() { MaKiemSoat = "", IdUser = "456", TenSach = "One Piece tâp 5", SoLuong = "3", NgayMuon = (new DateTime(2018, 2, 20)).Date.ToString("dd-MM-yyyy"), NgayTra = (new DateTime(2018, 8, 28)).Date.ToString("dd-MM-yyyy"),
        ...
        public JsonResult GetBook(string maSach)
        {
            ...
            var list = _SachLogicLogic.getAllSach();
