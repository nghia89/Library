...
namespace BiTech.Library.DAL.Engines
{
    public class TacGiaEngine : EntityRepository<TacGia>
    {
        ...
        {
            var aa = (typeof(TacGia).GetCustomAttributes(typeof(Mongo.Migration.Documents.Attributes.CurrentVersion), true).FirstOrDefault() as Mongo.Migration.Documents.Attributes.CurrentVersion);
